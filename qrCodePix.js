function qrCodePix(merchant_account, merchant_name, merchant_city, transaction_amount){
  var crcTable = [
  ...
  let account = "26" + (gui.length + chave.length) + gui + chave; //Merchant Account Information
  let category = "52040000"; //Merchant Category Code
  let currency = "5303986"; //Transaction Currency (R$)
  let amount = "54" + (transaction_amount.length < 10 ? "0" + transaction_amount.length : transaction_amount.length) + transaction_amount; //Transaction Amount
...
qrCodePix("e91e0334-2b7d-41ec-89b8-65d127086925", "FULANO DE TAL", "VITORIA", "123.45");